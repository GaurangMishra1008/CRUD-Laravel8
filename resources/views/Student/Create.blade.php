                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="/submit" method="POSt" class="form-horizontal" id="#form_add">
                                    @csrf
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="name" name="name" placeholder="Enter Name" class="form-control"><small class="form-text text-muted">Enter Your Name</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Subject</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="subject" name="subject" placeholder="Enter Subject" class="form-control"><small class="help-block form-text">Enter Your Subject</small></div>
                                    </div>


                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Description</label></div>
                                        <div class="col-12 col-md-9"><textarea name="description" id="description" rows="5" placeholder="Enter Your Description" class="form-control"></textarea></div>
                                    </div>
