...
<body>
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <a class="nav-link" href="/login"><i class="fa fa-power-on"></i>Login</a>
    ...
    <div class="badge-dark col-8 m-l-10 m-b-10">
    <h1>You have no access to view this page..</h1>    
    <h2>Please Login</h2>
    
    </div>
    <a href="/login"> <button  class="badge-primary">CLick Me</button></a>
