                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media bg-flat-color-1" href="#">
                                <span class="photo media-left"><img alt="avatar" src="{{URL::asset('images/avatar/1.jpg')}}"></span>
                                                    ...
                                                    <div class="card-body card-block">
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="name" placeholder="" value="{{$data->name}}" class="form-control"><small class="form-text text-muted">Enter Your Name</small></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Subject</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="subject" value="{{$data->subject}}" class="form-control"><small class="help-block form-text">Enter Your Subject</small></div>
                                                            </div>
                                                        
                                                
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Description</label></div>
                                                                <div class="col-12 col-md-9"><textarea name="Description" id="textarea-input" rows="5" placeholder="" class="form-control">{{$data->Description}}</textarea></div>
                                                            </div>
