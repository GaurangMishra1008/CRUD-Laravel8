                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="user" method="post" class="form-horizontal" id="#form_add">
                                    @csrf
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="user" name="user" placeholder="Enter username" class="form-control"><small class="form-text text-muted">Enter Your user</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="password" name="password" placeholder="Enter Password" class="form-control"><small class="help-block form-text">Enter Your Password</small></div>
                                    </div>
