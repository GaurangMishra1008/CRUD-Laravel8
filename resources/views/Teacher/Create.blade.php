...
<head>
    ...
    <title>Teacher - HTML5 Admin Template</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class=""></i><a href="/ViewTeacher">View Student Record</a></li>
                        </ul>
                    </li>
            </div><!-- /.navbar-collapse -->
        </nav>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa-user"></i>{{session('user')}}</a>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="/submitTeacher" method="post" class="form-horizontal" >
                                    @csrf
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="Teacher_name" name="Teacher_name" placeholder="Enter Name" class="form-control"><small class="form-text text-muted">Enter Your Name</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Stream</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="stream" name="stream" placeholder="Enter Stream" class="form-control"><small class="help-block form-text">Enter Your Stream</small></div>
                                    </div>
